...
# sg_filter = SavitzkyGolay(window_size=20, polynomial_order=2, derivate_order=2)
...
# predict the Brix
label_pred = pls.predict(X_train_o)

# plot
fig, ax = plt.subplots(figsize=(4, 4))
ax.scatter(y_train_o, label_pred, color='blue')
...
z = np.polyfit(y_train_o.ravel(), label_pred.ravel(), 1)
p = np.poly1d(z)
ax.plot(y_train_o, p(y_train_o), color='red', label='Trendline')

# Calculate R² and MSE
r2 = r2_score(y_train_o, label_pred)
mse = mean_squared_error(y_train_o, label_pred)
...
print(f"R²: {r2:.3f}")
print(f"MSE: {mse:.3f}")
variance_brix = np.var(y_train_o)
print(f"Variance of Brix: {variance_brix:.3f}")

plt.show()

min_label = np.min(y_train_o)
max_label = np.max(y_train_o)
mean_label = np.mean(y_train_o)
std_label = np.std(y_train_o)
...
SG_label_pred = best_model.predict(X_train)

# plot the predictions
fig, ax = plt.subplots(figsize=(4, 4))
ax.scatter(y_train, SG_label_pred, color='blue')
...
# Fit a linear trendline
z = np.polyfit(y_train.ravel(), SG_label_pred.ravel(), 1)
p = np.poly1d(z)
ax.plot(y_train, p(y_train), color='red', label='Trendline')

# Calculate R² and MSE
SG_r2 = r2_score(y_train, SG_label_pred)
SG_mse = mean_squared_error(y_train, SG_label_pred)
...
# # predict the Brix
# MF_label_pred = pls.predict(X_train_m)
MF_label_pred = best_model.predict(X_train_m)

# plot
fig, ax = plt.subplots(figsize=(4, 4))
ax.scatter(y_train_m, MF_label_pred, color='blue')
ax.plot([7, 15], [7, 15], color='magenta')
ax.set_xlabel('Measured Brix')
ax.set_ylabel('Predicted Brix')
...
# Fit a linear trendline
z = np.polyfit(y_train_m.ravel(), MF_label_pred.ravel(), 1)
p = np.poly1d(z)
ax.plot(y_train_m, p(y_train_m), color='red', label='Trendline')

# Calculate R² and MSE
r2 = r2_score(y_train_m, MF_label_pred)
mse = mean_squared_error(y_train_m, MF_label_pred)
...
print(f"R²: {r2:.3f}")
print(f"MSE: {mse:.3f}")
variance_brix = np.var(y_train_m)
print(f"Variance of Brix: {variance_brix:.3f}")

plt.show()

min_label = np.min(y_train_m)
max_label = np.max(y_train_m)
mean_label = np.mean(y_train_m)
std_label = np.std(y_train_m)
...
SG_label_pred_svr = grid_search_svr.best_estimator_.predict(X_train)

# Plot the predictions (similar to PLSR)
plt.scatter(y_train_1d, SG_label_pred_svr, color='blue')
plt.plot([7, 15], [7, 15], color='magenta')
plt.xlabel('Measured Brix')
plt.ylabel('Predicted Brix')
plt.title('SVR Predictions')
plt.text(7.2, 14.8, f"$R^2$: {r2_score(y_train_1d, SG_label_pred_svr):.3f}", fontsize=12, color='black')  # Add R² score at the top left corner
plt.legend()
plt.show()

# Evaluate the model
print("Best parameters for SVR: ", grid_search_svr.best_params_)
print(f"R²: {r2_score(y_train_1d, SG_label_pred_svr):.3f}")
print(f"MSE: {mean_squared_error(y_train_1d, SG_label_pred_svr):.3f}")
...
# Predict the Brix levels using the best SVR model
label_pred_svr = grid_search_svr.best_estimator_.predict(X_train_o)

# Plot the predictions (similar to PLSR)
plt.scatter(y_train_o_1d, label_pred_svr, color='blue')
plt.plot([7, 15], [7, 15], color='magenta')
plt.xlabel('Measured Brix')
plt.ylabel('Predicted Brix')
plt.title('SVR Predictions with original data')
plt.text(7.2, 14.8, f"$R^2$: {r2_score(y_train_o_1d, label_pred_svr):.3f}", fontsize=12, color='black')  # Add R² score at the top left corner
plt.show()


# Evaluate the model
print("Best parameters for SVR: ", grid_search_svr.best_params_)
print(f"R²: {r2_score(y_train_o_1d, label_pred_svr):.3f}")
print(f"MSE: {mean_squared_error(y_train_o_1d, label_pred_svr):.3f}")
...
SG_label_pred_rf = rf.predict(X_train)

# Plot
plt.scatter(y_train_1d, SG_label_pred_rf, color='green')
plt.plot([7, 15], [7, 15], color='magenta')
plt.xlabel('Measured Brix')
plt.ylabel('Predicted Brix')
...
# Predict on the entire dataset
label_pred_rf = rf.predict(X_train_o)

# Plot
plt.scatter(y_train_o_1d, label_pred_rf, color='green')
plt.plot([7, 15], [7, 15], color='magenta')
plt.xlabel('Measured Brix')
plt.ylabel('Predicted Brix')
...
predicted_brix = best_mlp_model.predict(X_train)

# Plot actual vs predicted values
import matplotlib.pyplot as plt
plt.scatter(y_train_1d, predicted_brix, color='blue')
plt.plot([min(y_train_1d), max(y_train_1d)], [min(y_train_1d), max(y_train_1d)], color='magenta')
plt.xlabel('Measured Brix')
plt.ylabel('Predicted Brix')
...
# Predict with the best model
predicted_brix = best_mlp_model.predict(X_train_o)

# Plot actual vs predicted values
import matplotlib.pyplot as plt
plt.scatter(y_train_o_1d, predicted_brix, color='blue')
plt.plot([min(y_train_o_1d), max(y_train_o_1d)], [min(y_train_o_1d), max(y_train_o_1d)], color='magenta')
plt.xlabel('Measured Brix')
plt.ylabel('Predicted Brix')
...
predicted_brix = knn.predict(X_train)
...
predicted_brix = knn.predict(X_train_o)
...
predicted_brix = xgb.predict(X_train)
...
predicted_brix = xgb.predict(X_train_o)
...
predicted_brix_plsr = final_models['PLSR'].predict(X_train)
predicted_brix_svr = final_models['SVR'].predict(X_train)
predicted_brix_rf = final_models['Random Forest'].predict(X_train)
predicted_brix_ann = final_models['ANN'].predict(X_train)
predicted_brix_knn = final_models['KNN'].predict(X_train)
predicted_brix_xgb = final_models['XGBoost'].predict(X_train)
