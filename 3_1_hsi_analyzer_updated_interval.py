...
SG_label_pred_svc = grid_search_svc.best_estimator_.predict(X_test)

# Plot the predictions (similar to PLSR)
plt.scatter(y_test_1d, SG_label_pred_svc, color='blue')
...
print(f"R²: {r2_score(y_test_1d, SG_label_pred_svc):.3f}")
print(f"MSE: {mean_squared_error(y_test_1d, SG_label_pred_svc):.3f}")
...
SG_label_pred_rf = rf.predict(X_test).round()
